...
- `tidytext`: (0.2.1 version)[https://cran.r-project.org/package=tidytext] big hooray for new plotting functions
-  (`textdata`)[https://github.com/EmilHvitfeldt/textdata]

## Text Preprocessing 
1. Text extraction: remove Web-specific elements

2. Stop-word removal: commonly occurring words with little discriminative power
